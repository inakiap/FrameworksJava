...
<div class="container">
      <div class="header clearfix">
        <nav>
          <ul class="nav nav-pills pull-right">
            <li role="presentation" class="active"><a href="index.jsp" >Vovler</a></li>
   ...
   <div class="container">
     <div class="jumbotron">
<h1>Personika</h1>
<h3>Nombre: <s:property value="nombre"/></h3>
<h3>Edad: <s:property value="edad"/></h3>
<p><s:property value="persona"/>
</p>
</div>
 <div class="container">
		<footer class="footer">
