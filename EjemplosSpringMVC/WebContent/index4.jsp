...
function llamadaRest()
{
	...
	xmlHttp.open('PUT', 'personaJSONPUT', true); //primer parámetro = protocolo http que se usa; el segundo parámetro la url que se crea; el tercer parámetro indica si es asíncrono o no true es asíncrono
	xmlHttp.setRequestHeader('Content-Type', 'application/json'); //en la petición acepta este formato, si no pongo nada sería cualquiera
